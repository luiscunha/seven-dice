...
import type { Tema } from "../session/settings";
...
export class DefinicoesScreen {
  ...
  constructor(host: HTMLElement, opcoes: OpcoesDefinicoes) {
    ...
    rolo.append(this.seccaoTema(), this.seccaoProgresso());
  ...
  private seccaoProgresso(): HTMLElement {
    const el = this.seccao(
      "Progresso",
      "Apaga os selos, os melhores resultados e o modo tempo. Não tem volta.",
    );
